...
- Implemented and test-covered scope includes:
  ...
  - control-plane policy schema and strict validation baseline in `verzola-control` (Unit U3 Bolt U3-B1), including parser/validator diagnostics and CLI validation workflow.
...
- Remaining control-plane rendering/reporting work plus TLS capability/PQ classification, observability packaging, and deployment/release hardening remain planned (`REQUIREMENTS.md` Unit U3 Bolts U3-B2/U3-B3 and Units U4-U6).
