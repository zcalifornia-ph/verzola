...
<h3 align="center">verzola</h3>
  ...
  <p align="center">
    Drop-in SMTP security sidecar for Postfix that makes STARTTLS policy-controlled and observable, with optional hybrid/post-quantum TLS preference (experimental).
    <br />
    Version: v1.0.2
    <br />
...
Here's a blank template to get started. To avoid retyping too much info, do a search and replace with your text editor for the following: `zcalifornia-ph`, `verzola`, `zcalifornia_`, `zcalifornia`, `up.edu.ph`, `zecalifornia`, `project_title`, `project_description`, `Apache-2.0`
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin zcalifornia-ph/verzola
...
See the [open issues](https://github.com/zcalifornia-ph/verzola/issues) for a full list of proposed features (and known issues).
...
Your Name - [@zcalifornia_](https://twitter.com/zcalifornia_) - zecalifornia@up.edu.ph.com
...
[license-url]: https://github.com/zcalifornia-ph/verzola/blob/master/LICENSE.txt
